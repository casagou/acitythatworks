...
/* City-accepted set: 7 mayor + 20 council. Name them; do not invent a count. */
const ACCEPTED_COUNCIL = [
  "Bowkett", "Caradonna", "Collins", "Cseszko", "Dell", "Dion",
  "Filipovic", "Garcia", "Gardiner", "Gibbs", "Girard", "Hammond",
  "Heit", "Kim", "Lee", "Loughton", "McInnis", "Rothe", "Sandor", "Thompson"
];
...
ok(/Bowkett, Caradonna, Collins, Cseszko, Dell, Dion, Filipovic, Garcia, Gardiner, Gibbs, Girard, Hammond, Heit, Kim, Lee, Loughton, McInnis, Rothe, Sandor and Thompson/.test(roster), "full accepted council list missing from roster");
...
console.log("check-field-3sep: ok — letters/counts locked, City list 7 mayor + 20 council, TC attribution, Johnston/Miller/Gervais-Harrison + Collins/Filipovic/Heit field-status only, /build 404 held");
